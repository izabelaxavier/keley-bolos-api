    ...
    public CommandLineRunner carregarBanco(ProdutoRepository produtoRepository) {
        return args -> {
            ...
            if (produtoRepository.count() > 0) {
                System.out.println("✅ O BANCO JA TEM DADOS! Mantendo historico seguro.");
                System.out.println("⏹️ Carga de dados cancelada para nao apagar pedidos.");
                return; // Para o codigo aqui e nao faz mais nada
            }

            System.out.println("🍰 BANCO VAZIO DETECTADO! Iniciando carga inicial do cardapio...");
            ...
            produtoRepository.saveAll(Arrays.asList(
                    ...
                    // --- TABELA 4: MASSA CHOCOLATE (PRESTIGIO) ---
